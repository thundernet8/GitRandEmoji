...
const people = [
    ...
    { emoji: "👩", alias: ":woman:", name: "WOMAN" },
    {
        emoji: "👱‍♀️",
        alias: ":blonde_woman:",
        name: "PERSON WITH BLOND HAIR, ZERO WIDTH JOINER, FEMALE SIGN, VARIATION SELECTOR-16"
    },
    ...
    },
    {
        ...
        name: "MAN WITH TURBAN, ZERO WIDTH JOINER, FEMALE SIGN, VARIATION SELECTOR-16"
    },
    { emoji: "👳", alias: ":man_with_turban:", name: "MAN WITH TURBAN" },
    {
        emoji: "👮‍♀️",
        alias: ":policewoman:",
        name: "POLICE OFFICER, ZERO WIDTH JOINER, FEMALE SIGN, VARIATION SELECTOR-16"
    },
    { emoji: "👮", alias: ":policeman:", name: "POLICE OFFICER" },
    {
        emoji: "👷‍♀️",
        alias: ":construction_worker_woman:",
        name: "CONSTRUCTION WORKER, ZERO WIDTH JOINER, FEMALE SIGN, VARIATION SELECTOR-16"
    },
    {
        emoji: "👷",
    ...
    { emoji: "💂", alias: ":guardsman:", name: "GUARDSMAN" },
    {
        ...
        name: "SLEUTH OR SPY, VARIATION SELECTOR-16, ZERO WIDTH JOINER, FEMALE SIGN, VARIATION SELECTOR-16"
    },
    {
        emoji: "🕵️",
    ...
    },
    {
        ...
        name: "WOMAN, ZERO WIDTH JOINER, STAFF OF AESCULAPIUS, VARIATION SELECTOR-16"
    },
    {
        emoji: "👨‍⚕️",
    ...
    { emoji: "🤰", alias: ":pregnant_woman:", name: "PREGNANT WOMAN" },
    {
        emoji: "🙇‍♀️",
        alias: ":bowing_woman:",
        name: "PERSON BOWING DEEPLY, ZERO WIDTH JOINER, FEMALE SIGN, VARIATION SELECTOR-16"
    },
    ...
    },
    {
        ...
        name: "INFORMATION DESK PERSON, ZERO WIDTH JOINER, MALE SIGN, VARIATION SELECTOR-16"
    },
    {
        emoji: "🙅",
        alias: ":no_good_woman:",
    ...
    },
    {
        emoji: "🙅‍♂️",
        alias: ":no_good_man:",
        name: "FACE WITH NO GOOD GESTURE, ZERO WIDTH JOINER, MALE SIGN, VARIATION SELECTOR-16"
    },
    { emoji: "🙆", alias: ":ok_woman:", name: "FACE WITH OK GESTURE" },
    {
        emoji: "🙆‍♂️",
        alias: ":ok_man:",
        name: "FACE WITH OK GESTURE, ZERO WIDTH JOINER, MALE SIGN, VARIATION SELECTOR-16"
    },
    {
        emoji: "🙋",
    ...
    },
    {
        ...
        name: "HAPPY PERSON RAISING ONE HAND, ZERO WIDTH JOINER, MALE SIGN, VARIATION SELECTOR-16"
    },
    {
        emoji: "🤦‍♀️",
    ...
    { emoji: "🙎", alias: ":pouting_woman:", name: "PERSON WITH POUTING FACE" },
    {
        emoji: "🙎‍♂️",
        alias: ":pouting_man:",
        name: "PERSON WITH POUTING FACE, ZERO WIDTH JOINER, MALE SIGN, VARIATION SELECTOR-16"
    },
    ...
    { emoji: "👯", alias: ":dancing_women:", name: "WOMAN WITH BUNNY EARS" },
    {
        emoji: "👯‍♂️",
        alias: ":dancing_men:",
        name: "WOMAN WITH BUNNY EARS, ZERO WIDTH JOINER, MALE SIGN, VARIATION SELECTOR-16"
    },
    {
        emoji: "🚶‍♀️",
        alias: ":walking_woman:",
    ...
    },
    {
        ...
        name: "WOMAN, ZERO WIDTH JOINER, HEAVY BLACK HEART, VARIATION SELECTOR-16, ZERO WIDTH JOINER, WOMAN"
    },
    {
        emoji: "👨‍❤️‍👨",
        alias: ":couple_with_heart_man_man:",
        name: "MAN, ZERO WIDTH JOINER, HEAVY BLACK HEART, VARIATION SELECTOR-16, ZERO WIDTH JOINER, MAN"
    },
    { emoji: "💏", alias: ":couplekiss_man_woman:", name: "KISS" },
    {
        emoji: "👩‍❤️‍💋‍👩",
        alias: ":couplekiss_woman_woman:",
        name: "WOMAN, ZERO WIDTH JOINER, HEAVY BLACK HEART, VARIATION SELECTOR-16, ZERO WIDTH JOINER, KISS MARK, ZERO WIDTH JOINER, WOMAN"
    },
    {
        emoji: "👨‍❤️‍💋‍👨",
        alias: ":couplekiss_man_man:",
        name: "MAN, ZERO WIDTH JOINER, HEAVY BLACK HEART, VARIATION SELECTOR-16, ZERO WIDTH JOINER, KISS MARK, ZERO WIDTH JOINER, MAN"
    },
    ...
    },
    {
        ...
        name: "MAN, ZERO WIDTH JOINER, WOMAN, ZERO WIDTH JOINER, GIRL, ZERO WIDTH JOINER, BOY"
    },
    {
        emoji: "👨‍👩‍👦‍👦",
        alias: ":family_man_woman_boy_boy:",
        name: "MAN, ZERO WIDTH JOINER, WOMAN, ZERO WIDTH JOINER, BOY, ZERO WIDTH JOINER, BOY"
    },
    {
        emoji: "👨‍👩‍👧‍👧",
        alias: ":family_man_woman_girl_girl:",
        name: "MAN, ZERO WIDTH JOINER, WOMAN, ZERO WIDTH JOINER, GIRL, ZERO WIDTH JOINER, GIRL"
    },
    {
        emoji: "👩‍👩‍👦",
    ...
    },
    {
        ...
        name: "WOMAN, ZERO WIDTH JOINER, WOMAN, ZERO WIDTH JOINER, GIRL, ZERO WIDTH JOINER, BOY"
    },
    {
        emoji: "👩‍👩‍👦‍👦",
        alias: ":family_woman_woman_boy_boy:",
        name: "WOMAN, ZERO WIDTH JOINER, WOMAN, ZERO WIDTH JOINER, BOY, ZERO WIDTH JOINER, BOY"
    },
    {
        emoji: "👩‍👩‍👧‍👧",
        alias: ":family_woman_woman_girl_girl:",
        name: "WOMAN, ZERO WIDTH JOINER, WOMAN, ZERO WIDTH JOINER, GIRL, ZERO WIDTH JOINER, GIRL"
    },
    {
        emoji: "👨‍👨‍👦",
    ...
    },
    {
        ...
        name: "MAN, ZERO WIDTH JOINER, MAN, ZERO WIDTH JOINER, GIRL, ZERO WIDTH JOINER, BOY"
    },
    {
        emoji: "👨‍👨‍👦‍👦",
        alias: ":family_man_man_boy_boy:",
        name: "MAN, ZERO WIDTH JOINER, MAN, ZERO WIDTH JOINER, BOY, ZERO WIDTH JOINER, BOY"
    },
    {
        emoji: "👨‍👨‍👧‍👧",
        alias: ":family_man_man_girl_girl:",
        name: "MAN, ZERO WIDTH JOINER, MAN, ZERO WIDTH JOINER, GIRL, ZERO WIDTH JOINER, GIRL"
    },
    {
        emoji: "👩‍👦",
